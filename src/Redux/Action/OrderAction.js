...
export const fetchCurrentOrders=(userEmail)=>async (dispatch)=>{
    ...
    console.log("🚀 ~ file: OrderAction.js ~ line 12 ~ fetchCurrentOrders ~ data", data)
...
export const fetchPriviesOrders=(userEmail)=>async (dispatch)=>{
    ...
    console.log("🚀 ~ file: OrderAction.js ~ line 19 ~ fetchPriviesOrders ~ data", data)
...
export const fetchAllOrders=()=>async (dispatch)=>{
    ...
    console.log("🚀 ~ file: OrderAction.js ~ line 27 ~ fetchAllOrders ~ data", data)
